...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        {headerName: "Customer Code", field: "CustomerPastelCode",width: 180},
        {headerName: "StoreName", field: "StoreName",width: 90},
        {headerName: "Date From", field: " Date",width: 90},
        {headerName: "Date To", field: "DateTo",width: 90}
    ];
    ...
    $('#submit').click(function () {
        ...
        fetch('{!!url("/checkifcustomerspecials")!!}/' + datefrom1 + "/" + dateto1).then(function (response) {
