...
<div class="table-container" style="height:100%">
    <div >
        ...
        Dispatch Comment<br><input id="strDispatchComments"  class="form-control" value="{{$orderdetailID[0]->strDispatchComments}}"readonly><br>
        Credit Dept Comment<br><textarea id="creditDeptMessage" class="form-control">{{$orderdetailID[0]->strCreditDeptComment}}</textarea><br>
