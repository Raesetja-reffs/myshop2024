...
<a href='{!!url("/getCustomerStoppedBuying")!!}' onclick="window.open(this.href, 'getCustomerStoppedBuying',
'left=20,top=20,width=1250,height=850,toolbar=1,resizable=0'); return false;" >See Customer Stopped Buying</a>
<h2>Stopped Buying </h2>
...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        ...
        {headerName: "Customer Name", field: "StoreName", width: 200},
    ...
    var gridOptions = {
        ...
        fetch('{!!url("/getProductsStopedBuyingJSon")!!}').then(function (response) {
