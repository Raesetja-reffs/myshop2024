...
<div style="background: yellow;    padding: 15px;" >
    ...
    Percentage Chance<select id="percentagechance">
...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        ...
        {headerName: "Cust Code", field: "CustomerPastelCode",width: 90},
        {headerName: "Name", field: "StoreName",width: 90},
        {headerName: "Comment", field: "Comment",width: 90},
        {headerName: "Order Message", field: "MESSAGESINV",width: 90},
        {headerName: "DeliveryDate", field: "DeliveryDate",width: 150},
        {headerName: "In stock", field: "Instock",width: 150},
        {headerName: "Ordered", field: "Ordered",width: 150},
        {headerName: "Prob", field: "prob",width: 150},
        {headerName: "Rep Code", field: "repCode",width: 150}
    ];
    ...
    $('#submit').click(function () {
        ...
        var percentagechance = $('#percentagechance').val();

        fetch('{!!url("/getJsonSrockVsOrdered")!!}/' + datefrom1 + "/" + dateto1+ "/" + percentagechance).then(function (response) {
