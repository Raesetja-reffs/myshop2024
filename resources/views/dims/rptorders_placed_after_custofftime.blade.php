...
<h2>Orders After Cut-Off Time</h2>
...
<div style="background: yellow;    padding: 15px;" >
   Order Date <input id="datefrom1" value="{{$date}}">
...
<script type="text/javascript" charset="utf-8">
    ...
    function getordersaftercusttoff()
    {
        $("#myGrid").empty();
        $('#myGrid').show();
        ...
        fetch('{!!url("/getJsonCutOffTime")!!}/' + datefrom1 , {'tableName': 'Tables'}).then(function (response) {
