...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready(function() {
        ...
        var columnDefs = [
            {headerName: "CustomerPastelCode", field: "CustomerCode",width: 90},
            {headerName: "Store Name", field: "StoreName",width: 480},
            {headerName: "Item Code", field: "strPartNumber",width: 90},
            {headerName: "Description", field: "strDesc",width: 130},
            {headerName: "Original Qty", field: "OrigQty",width: 90,filter: 'agNumberColumnFilter'},
            {headerName: "Back Order Quantity", field: "BackOrderQty",width: 90,filter: 'agNumberColumnFilter'},
            {headerName: "Price", field: "Price",width: 100},
            {headerName: "Captured Date", field: "capturedDate",width: 100,filter:'agDateColumnFilter' },
            {headerName: "DeliveryDate", field: "DeliveryDate",width: 100,filter:'agDateColumnFilter' },
            {headerName: "Captured By", field: "UserName",width: 130 }
        ...
        fetch('{!!url("/productsonbackorderjson")!!}').then(function (response) {
    ...
    function doSomething(row){
        ...
        window.open('{!!url("/customernoteshistory")!!}/'+customer, customer, "location=1,status=1,scrollbars=1, width=600,height=850");
