...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        {headerName: "Driver Name", field: "DriverName",width: 180},
        {headerName: "Value [Exc]", field: "randVal",width: 180},
        {headerName: "No Of Stops", field: "NoOfStops",width: 90},
        {headerName: "Mass", field: "Mass",width: 90},
        {headerName: "LinesCount", field: "LinesCount",width: 90}
    ];
    ...
    $('#submit').click(function () {
        ...
        fetch('{!!url("/getdriversandinfo")!!}/' + datefrom1 + "/" + dateto1).then(function (response) {
    ...
    function doSomething(row){
        ...
        window.open('{!!url("/customerupdatepricingfromcustomerssalespage")!!}/'+datefrom1+"/"+dateto1, dateto1, "location=1,status=1,scrollbars=1, width=1200,height=850");
