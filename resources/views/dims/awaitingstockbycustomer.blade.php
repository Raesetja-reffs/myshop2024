...
<script>
    ...
    function getItemsByOrderid(orderid){
        $.ajax({
            url: '{!!url("/jsonawaitingstockorderproductsfortheid")!!}',
            type: "GET",
    ...
    function getorders(){
        ...
        $.ajax({
            url: '{!!url("/jsonawaitingstockorderlistbycustomer")!!}',
            type: "GET",
            data: {
                productId:1
            },
            success: function (data) {
                ...
                $("#gridorders").dxDataGrid({
                    ...
                    onRowClick: function (e) {
                        ...
                        window.open('{!!url("/viewordersonawaiting")!!}/'+e.data.orderid, "Awaiting Stock By Order Id", "location=1,status=1,scrollbars=1, width=1200,height=850");
                    },
                    onCellClick: function (e) {
