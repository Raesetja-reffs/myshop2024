...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        {headerName: "Customer Code", field: "strCustCode",width: 180},
        {headerName: "Customer Name", field: "strCustomerName",width: 180},
        {headerName: "Coordinates", field: "coord",width: 180},
        {headerName: "User Name", field: "UserName",width: 90},
        {headerName: "Message", field: "strUserDefField1",width: 200},
        {headerName: "Visit Date", field: "dteCreated",width: 90}
    ];
    ...
    $('#submit').click(function () {
        ...
        fetch('{!!url("/visitsLog")!!}/' + datefrom1 + "/" + dateto1).then(function (response) {
