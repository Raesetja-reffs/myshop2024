...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        ...
        {headerName: "Item Description", field: "PastelDescription",width: 400},
        {headerName: "Price", field: "Price",width: 75},
        {headerName: "ProductId", field: "ProductId",width: 2},
        {headerName: "PastelCode", field: "PastelCode",width: 2}
    ...
    $('#submit').click(function () {
        ...
        fetch('{!!url("/listProdutsToBePrintedJson")!!}').then(function (response) {
    ...
    function doSomething(row){
        ...
        var PastelCode = row.data.PastelCode;
