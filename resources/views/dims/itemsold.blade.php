...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        ...
        {headerName: "Item Description", field: "PastelDescription"},
        {headerName: "This Year Qty", field: "thisyear",filter: 'agNumberColumnFilter',width: 90},
        {headerName: "Last Yeat Qty", field: "lastyear",filter: 'agNumberColumnFilter',width: 90},
        {headerName: "QTY Trend", field: "qtytrend",filter: 'agNumberColumnFilter'},
        {headerName: "Trend %", field: "trendPercent",filter: 'agNumberColumnFilter',width: 90, valueParser: numberParser,
            cellClassRules: {
                'rag-red': 'x < 10',
                'rag-amber': 'x >= 10 && x < 25',
                'rag-green': 'x >= 25'
            }},
        {headerName: "In stock(C)", field: "Instock"},
        {headerName: "Available(C)", field: "Available"},
        {headerName: "Price(C)", field: "Price"},
        {headerName: "Cost(C)", field: "Cost"}
    ];
    ...
    $("#sub").click(function(){
        ...
        fetch('{!!url("/customersalesperiod")!!}/'+$('#datefrom').val()+"/"+$('#dateto').val()).then(function(response) {
