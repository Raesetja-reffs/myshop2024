...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        {headerName: "Warehouse", field: "Warehouse",width: 250},
        {headerName: "Cash Collected", field: "cash",width: 200}
    ];
    ...
    $('#submit').click(function () {
        ...
        fetch('{!!url("/cashCollectedReport")!!}/' + datefrom1 + "/" + dateto1).then(function (response) {
