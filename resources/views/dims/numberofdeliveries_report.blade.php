...
<h2>Number Of Deliveries Report </h2>
...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        {headerName: "Cust Code", field: "CustomerPastelCode",width: 180},
        {headerName: "Cust Name", field: "StoreName",width: 180},
        {headerName: "No Of Del", field: "NoOfDel",filter: 'agNumberColumnFilter',width: 90,sortable: true},
        {headerName: "Order Value", field: "OrderValue",filter: 'agNumberColumnFilter',width: 100,sortable: true},
        {headerName: "Order Cost", field: "OrderCost",filter: 'agNumberColumnFilter',width: 100,sortable: true},
        {headerName: "Order GP", field: "OrderGP",filter: 'agNumberColumnFilter',width: 100,sortable: true},
        {headerName: "Avg GP", field: "AvgGP",filter: 'agNumberColumnFilter',width: 90,sortable: true},
    ];
    ...
    $('#submit').click(function () {
        ...
        fetch('{!!url("/getNoOfDelPerCustomer")!!}/' + datefrom1 + "/" + dateto1).then(function (response) {
