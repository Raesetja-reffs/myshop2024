...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        {headerName: "Code", field: "PastelCode",width: 70},
        {headerName: "Description", field: "PastelDescription",width: 200},
        {headerName: "This Year", field: "thisyear",width: 70},
        {headerName: "Last Year", field: "lastyear",width: 75},
        {headerName: "Qty Trend", field: "qtytrend",width: 80},
        {headerName: "Cost", field: "Cost",width: 80},
        {headerName: "Price", field: "Price",width: 80},
        {headerName: "Special Price", field: "cutp",width: 80},
        {headerName: "List Price", field: "listprice",width: 80},
    ...
    var gridOptions = {
        ...
        fetch('{!!url("/printcustomerpricingjson")!!}/' + $('#custAcc').val()+'/'+$('#dateFromFilter').val()+'/'+$('#dateToFilter').val()+'/'+$('#dateFromFilter2').val()+'/'+$('#dateToFilter2').val()).then(function (response) {
