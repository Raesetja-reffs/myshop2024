...
<h2>Customer Stopped Buying  </h2>
<h5>This information is calculated using the customer buying pattern.</h5>
...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        ...
        {headerName: "Code", field: "CustomerPastelCode", width: 200},
        {headerName: "Customer Name", field: "StoreName", width: 350},
        {headerName: "Address", field: "DelAddress", width: 250}
    ...
    fetch('{!!url("/getCustomerStoppedBuyingJSon")!!}').then(function (response) {
