...
<div style="background: yellow;    padding: 15px;" >
    Date From <input id="datefrom1" value="{{$dateFrom}}">
    Date To<input id="dateeto1" value="{{$dateTo}}">
    Group Id<input id="groupid" value="{{$groupid}}">
...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        {headerName: "Item Code", field: "PastelCode",width: 140},
        {headerName: "Item Description", field: "PastelDescription",width: 250},
    ...
    var gridOptions = {
        ...
        fetch('{!!url("/jsonViewgroupspecialExcel")!!}/' + datefrom1 + "/" + dateto1+"/"+groupid).then(function (response) {
