            ...
            <div class="col-md-3 col-sm-12">
                ...
                <div class="row">
                    <div class="col-md-4 mb-2">
                        <label for="invoiceNo">Inv No.</label>
                        <input type="text" class="form-control" id="invoiceNo" autocomplete="off">
                        <input type="hidden" id="invoiceNoKeeper">
                    </div>
                    <div class="col-md-4 mb-2">
                        <label for="orderId">Order ID</label>
                        <input type="number" class="form-control disable-input-type-number-arrows" id="orderId"
                            autocomplete="off">
                    </div>
                    <div class="col-md-3 mt-md-6 mb-4">
            ...
            <div class="col-md-9 col-sm-12">
                ...
                <div class="row">
                    <div class="col-md-2 mb-2">
                        <label class="text-nowrap" for="orderType">Delivery Type</label>
                    ...
                    <div class="col-md-1 mt-md-6 mb-2">
                        <button type="button" id="submitFilters"
                            class="btn btn-primary btn-sm ps-6 pe-6">Submit</button>
                    </div>
                </div>
            </div>
        </div>
