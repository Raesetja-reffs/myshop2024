...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        {headerName: "Picker Name", field: "PickerName",width: 180},
        {headerName: "No Of Lines", field: "NOLines",width: 90},
        {headerName: "Sum OF Qty", field: "SOQty",width: 90},
    ...
    $('#submit').click(function () {
        ...
        fetch('{!!url("/bulkPickingPerUserJSON")!!}/' + datefrom1 + "/" + dateto1).then(function (response) {
