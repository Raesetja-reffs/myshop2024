...
<div style="background: yellow;    padding: 15px;" >
    ...
    <input id="groupId" value="{{$groupId}}">
...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        {headerName: "GroupId", field: "GroupId",width: 10},
        ...
        {headerName: "Cost When Creating Special", field: "CostPrice",width: 90,filter: 'agNumberColumnFilter'}
    ];
    ...
    $('#submit').click(function () {
        ...
        fetch('{!!url("/groupspecialsbulkediting")!!}/' + $('#groupId').val()+'/'+ $('#datefrom').val()+'/'+ $('#dateTo').val() ).then(function (response) {
    ...
    function onBtForEachNode() {
        ...
        $.ajax({
            url: '{!!url("/XmlBulkEditingGroupSpecials")!!}',
            type: "POST",
            data: {
                value: values
            },
