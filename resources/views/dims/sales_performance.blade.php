...
<script type="text/javascript" charset="utf-8">
    ...
    var columnDefs = [
        ...
        {headerName: "Mass", field: "Mass",width: 200},
        {headerName: "No Of Orders", field: "NoOfOrders",width: 200},
        {headerName: "No Of Lines", field: "NoOfLines",width: 200},
        {headerName: "Rand Value", field: "RandVal",width: 200},
    ...
    $('#submit').click(function () {
        ...
        fetch('{!!url("/salesPerformance")!!}/' + datefrom1 + "/" + dateto1).then(function (response) {
