...
*/
    ...
    var columnDefs = [
        ...
        {headerName: "Available Stock", field: "Available",filter: 'agNumberColumnFilter',valueFormatter:valueFormatterfn,width: 200,sortable: true},
        {headerName: "Original Qty", field: "mnyOriginalQty",filter: 'agNumberColumnFilter',valueFormatter:valueFormatterfn,width: 200,sortable: true},
        {headerName: "Adjusted Qty", field: "mnyOriginaldPickedQty",filter: 'agNumberColumnFilter',valueFormatter:valueFormatterfn,width: 200,sortable: true},
        {headerName: "Delivery Date", field: "dteDelDate",filter: 'agNumberColumnFilter',width: 100,sortable: true},
        {headerName: "Route Type", field: "OrderType" ,width: 90,sortable: true},
        {headerName: "Area", field: "Route" ,width: 130,sortable: true},
        {headerName: "Action Time", field: "dteTime" ,width: 230,sortable: true},
        {headerName: "UserName", field: "UserName" ,width: 130,sortable: true},
    ];
    ...
    $('#submit').click(function () {
        ...
        fetch('{!!url("/jsonadjustmentspicking")!!}/' + datefrom1 + "/" + dateto1).then(function (response) {
