<x-app-layout>
    ...
    <x-slot name="breadcrum">
        ...
        <li class="breadcrumb-item text-dark">Add Report Builder File </li>
    </x-slot>
        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('report-builder-files.store') }}" class="addnovalidate" enctype="multipart/form-data">
                                @csrf
