...
class CreateAaaMyCustDelAddressesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aaaMyCustDelAddresses', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('aaaMyCustDelAddresses');
    }
}
