...
class CreateAaaDeliveryAddressesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aaaDeliveryAddresses', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('aaaDeliveryAddresses');
    }
}
