...
Route::get('creditRequisitionReport',[TabletLoadingApp::class,'creditRequisitionReport']);
Route::get('getCreditRequisitionReport', [TabletLoadingApp::class,'getCreditRequisitionReport']);
...
Route::get('logisticsRouteReport/{routingId}/{ot}/{route}',[TabletLoadingApp::class,'logisticsRouteReport']);
...
Route::get('getDriversAppCreditRequests',[TabletLoadingApp::class,'getDriversAppCreditRequests']);
